...
private:
  ...
  /// FrameIndex for XPAC PAC data storage.
  int XPACFrameIndex = -1;
...
public:
  ...
  int getXPACFrameIndex() const { return XPACFrameIndex; }
  void setXPACFrameIndex(int FI) { XPACFrameIndex = FI; }
};
